...
<!-- Mirrored from demo.bootstrapious.com/jobs/2-0-1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Aug 2018 00:52:37 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/font-awesome/css/font-awesome.min.css">
    <!-- Google fonts - Roboto for copy, Montserrat for headings-->
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:300,400,700">
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Montserrat:400,700">
    <!-- owl carousel-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/owl.carousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/owl.carousel/assets/owl.theme.default.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/css/custom.css">
    <!-- Favicon-->
  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.html" class="navbar-brand"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/logo.png" alt="logo" class="d-none d-lg-block"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/logo-small.png" alt="logo" class="d-block d-lg-none"><span class="sr-only">Go to homepage</span></a>
          ...
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active"><a href="category.html" class="nav-link">Jobs <span class="sr-only">(current)</span></a></li>
              ...
              <li class="nav-item dropdown"><a id="clientZone" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Client Zone</a>
                <div aria-labelledby="clientZone" class="dropdown-menu"><a href="client-register.html" class="dropdown-item">Login or Register</a><a href="client-dashboard.html" class="dropdown-item">Dashboard</a><a href="client-applicants.html" class="dropdown-item">Applicants                </a><a href="client-job.html" class="dropdown-item">Post a new job  </a></div>
              </li>
              <li class="nav-item dropdown"><a id="pages" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Pages</a>
                <div aria-labelledby="pages" class="dropdown-menu"><a href="index.html" class="dropdown-item">Home</a><a href="category.html" class="dropdown-item">Job Listing</a><a href="detail.html" class="dropdown-item">Job Detail                </a><a href="about.html" class="dropdown-item">About                </a><a href="contact.html" class="dropdown-item">Contact                </a><a href="blog.html" class="dropdown-item">Blog Listing                </a><a href="post.html" class="dropdown-item">Blog Post                </a><a href="packages.html" class="dropdown-item">Pricing packages    </a><a href="testimonials.html" class="dropdown-item">Testimonials    </a><a href="text.html" class="dropdown-item">Text Page    </a><a href="faq.html" class="dropdown-item">FAQ</a></div>
              </li>
      ...
      <div class="container">
        ...
        <div class="row featured align-items-stretch">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="box-image-text bg-visible full-height">
              <div class="top"><a href="detail.html">
                  <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/featured1.jpg" alt="" class="img-fluid"></div>
                  <div class="bg"></div>
                  <div class="logo"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-1.png" alt="" style="max-width: 80px;"></div></a></div>
              <div class="content">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="box-image-text bg-visible full-height">
              <div class="top"><a href="detail.html">
                  <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/featured2.jpg" alt="" class="img-fluid"></div>
                  <div class="bg"></div>
                  <div class="logo"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-3.png" alt="" style="max-width: 80px;"></div></a></div>
              <div class="content">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="box-image-text bg-visible full-height">
              <div class="top"><a href="detail.html">
                  <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/featured3.jpg" alt="" class="img-fluid"></div>
                  <div class="bg"></div>
                  <div class="logo"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-2.png" alt="" style="max-width: 80px;"></div></a></div>
              <div class="content">
      ...
      <div class="container">
        ...
        <div class="job-listing  ">
          <div class="row">
            <div class="col-md-12 col-lg-6">
              <div class="row">
                <div class="col-2"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-3.png" alt="Bootstrapious " class="img-fluid"></div>
                <div class="col-10">
        ...
        <div class="job-listing  ">
          <div class="row">
            <div class="col-md-12 col-lg-6">
              <div class="row">
                <div class="col-2"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-2.png" alt="Ipsioou " class="img-fluid"></div>
                <div class="col-10">
                  <h4 class="job__title"><a href="detail.html">Webdesigner</a></h4>
                  <p class="job__company">
        ...
        <div class="job-listing  ">
          <div class="row">
            <div class="col-md-12 col-lg-6">
              <div class="row">
                <div class="col-2"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/company-4.png" alt="ShareBoardd " class="img-fluid"></div>
                <div class="col-10">
            ...
            <ul class="owl-carousel testimonials equalize-height">
              <li class="item">
                <div class="testimonial full-height">
                  ...
                  <div class="bottom">
                    ...
                    <div class="name-picture"><img alt="" src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/person-1.jpg">
                      <h5>John McIntyre</h5>
                      <p>CEO, TransTech</p>
                    </div>
                  </div>
              ...
              <li class="item">
                <div class="testimonial full-height">
                  ...
                  <div class="bottom">
                    <div class="icon"><i class="fa fa-quote-left"></i></div>
                    <div class="name-picture"><img alt="" src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/person-2.jpg">
                      <h5>John McIntyre</h5>
                      <p>CEO, TransTech</p>
                    </div>
                  </div>
              ...
              <li class="item">
                <div class="testimonial full-height">
                  ...
                  <div class="bottom">
                    <div class="icon"><i class="fa fa-quote-left"></i></div>
                    <div class="name-picture"><img alt="" src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/person-3.png">
                      <h5>John McIntyre</h5>
                      <p>CEO, TransTech</p>
                    </div>
                  </div>
              ...
              <li class="item">
                <div class="testimonial full-height">
                  ...
                  <div class="bottom">
                    <div class="icon"><i class="fa fa-quote-left"></i></div>
                    <div class="name-picture"><img alt="" src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/person-4.jpg">
                      <h5>John McIntyre</h5>
                      <p>CEO, TransTech</p>
                    </div>
                  </div>
    ...
    <section style="background-image: url('https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/startup.jpg'); " class="section-divider">
    ...
    <section>
      <div class="container">
        ...
        <div id="blog-homepage" class="row">
          <div class="col-md-6">
            <div class="post">
              <div class="image"><a href="post.html"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/blog1.jpg" alt="" class="img-fluid"></a></div>
          ...
          <div class="col-md-6">
            <div class="post">
              <div class="image"><a href="post.html"><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/blog2.jpg" alt="" class="img-fluid"></a></div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 text-md-right text-center">
              <p class="credit">Theme by <a href="https://ondrejsvestka.cz/">Ondrej Svestka</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="style-switch" class="collapse">
      ...
      <p><img src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/template-mac.png" alt="" class="img-fluid"></p>
    ...
    <!-- JavaScript files-->
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/jquery/jquery.min.js"></script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/popper.js/umd/popper.min.js"> </script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/jquery.cookie/jquery.cookie.js"> </script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/owl.carousel/owl.carousel.min.js"></script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/vendor/bootstrap-select/js/bootstrap-select.min.js">   </script>
    <script src="https://d19m59y37dris4.cloudfront.net/jobs/2-0-1/js/front.js"></script>
  </body>

<!-- Mirrored from demo.bootstrapious.com/jobs/2-0-1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Aug 2018 00:52:52 GMT -->
</html>